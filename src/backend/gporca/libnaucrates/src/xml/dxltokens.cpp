...
CDXLTokens::Init(CMemoryPool *mp)
{
	...
	SWszMapElem rgStrMap[] = {
		...
		{EdxltokenPhysicalParallelBitmapTableScan, GPOS_WSZ_LIT("ParallelBitmapTableScan")},
		...
		{EdxltokenPhysicalParallelIndexOnlyScan, GPOS_WSZ_LIT("ParallelIndexOnlyScan")},
		...
		{EdxltokenPhysicalParallelWindow, GPOS_WSZ_LIT("ParallelWindow")},
		...
		{EdxltokenRelStorageIceberg, GPOS_WSZ_LIT("Iceberg")},
