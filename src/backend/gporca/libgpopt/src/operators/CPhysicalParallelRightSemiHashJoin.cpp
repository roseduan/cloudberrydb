...
//---------------------------------------------------------------------------
//	@filename:
//		CPhysicalParallelRightSemiHashJoin.cpp
//
//	@doc:
//		Implementation of parallel right semi hash join operator.
...
CPhysicalParallelRightSemiHashJoin::CPhysicalParallelRightSemiHashJoin(
...
CPhysicalParallelRightSemiHashJoin::PppsRequired(
...
CPartitionPropagationSpec *
CPhysicalParallelRightSemiHashJoin::PppsDerive(
...
BOOL
CPhysicalParallelRightSemiHashJoin::FProvidesReqdCols(
