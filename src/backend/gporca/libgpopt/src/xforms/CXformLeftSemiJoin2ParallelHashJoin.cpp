...
#include "gpopt/xforms/CXformLeftSemiJoin2ParallelHashJoin.h"
...
//---------------------------------------------------------------------------
//	@function:
//		CXformLeftSemiJoin2ParallelHashJoin::CXformLeftSemiJoin2ParallelHashJoin
//
//	@doc:
//		ctor
//
...
//---------------------------------------------------------------------------
//	@function:
//		CXformLeftSemiJoin2ParallelHashJoin::Exfp
//
//	@doc:
...
CXformLeftSemiJoin2ParallelHashJoin::Exfp(CExpressionHandle &exprhdl) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CXformLeftSemiJoin2ParallelHashJoin::Transform
//
//	@doc:
...
//---------------------------------------------------------------------------
void
CXformLeftSemiJoin2ParallelHashJoin::Transform(CXformContext *pxfctxt,
												CXformResult *pxfres,
												CExpression *pexpr) const
{
	...
	{
		CXformUtils::ImplementHashJoin<CPhysicalParallelLeftSemiHashJoin>(
