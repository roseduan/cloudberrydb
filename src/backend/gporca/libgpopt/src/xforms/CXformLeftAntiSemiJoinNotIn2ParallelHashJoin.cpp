...
//---------------------------------------------------------------------------
//	@filename:
//		CXformLeftAntiSemiJoinNotIn2ParallelHashJoin.cpp
//
//	@doc:
//		Transform left anti semi join NotIn to parallel hash join
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
//	@function:
//		CXformLeftAntiSemiJoinNotIn2ParallelHashJoin::CXformLeftAntiSemiJoinNotIn2ParallelHashJoin
//
//	@doc:
//		ctor
//
...
//---------------------------------------------------------------------------
//	@function:
//		CXformLeftAntiSemiJoinNotIn2ParallelHashJoin::Exfp
//
//	@doc:
...
CXformLeftAntiSemiJoinNotIn2ParallelHashJoin::Exfp(CExpressionHandle &exprhdl) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CXformLeftAntiSemiJoinNotIn2ParallelHashJoin::Transform
//
//	@doc:
...
//---------------------------------------------------------------------------
void
CXformLeftAntiSemiJoinNotIn2ParallelHashJoin::Transform(CXformContext *pxfctxt,
														 CXformResult *pxfres,
														 CExpression *pexpr) const
{
	...
	{
		CXformUtils::ImplementHashJoin<CPhysicalParallelLeftAntiSemiHashJoinNotIn>(
