...
//
//	@doc:
//		Translate DXL Parallel CTE Producer node into GPDB parallel share input scan plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLParallelCTEProducerToParallelSharedScan(
...
//
//	@doc:
//		Translate Parallel DXL CTE Consumer node into GPDB parallel share input scan plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLParallelCTEConsumerToParallelSharedScan(
...
//
//	@doc:
//		Translate Parallel DXL sequence node into GPDB parallel Sequence plan node
//
//---------------------------------------------------------------------------
Plan *
CTranslatorDXLToPlStmt::TranslateDXLParallelSequence(
...
CTranslatorDXLToPlStmt::ExtractParallelWorkersFromDXL(const CDXLNode *dxlnode)
{
	...
	else if (EdxlopPhysicalParallelCTEConsumer == dxlop->GetDXLOperator())
	{
		CDXLPhysicalParallelCTEConsumer *parallel_cte_consumer_dxlop =
			CDXLPhysicalParallelCTEConsumer::Cast(dxlop);
		return parallel_cte_consumer_dxlop->UlParallelWorkers();
	}
