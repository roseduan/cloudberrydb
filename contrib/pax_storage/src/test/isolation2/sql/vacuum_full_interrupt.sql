...
1: SELECT relfrozenxid, relhasindex, reltuples FROM pg_class WHERE relname='vacuum_full_interrupt';
...
2: SELECT relfrozenxid, relhasindex, reltuples FROM pg_class WHERE relname='vacuum_full_interrupt';
0U: SELECT relfrozenxid, relhasindex, reltuples FROM pg_class WHERE relname='vacuum_full_interrupt';
